...
class TestBase_save_to_file(unittest.TestCase):
    ...
    def test_save_to_file_one_rectangle(self):
        ...
        with open("Rectangle.json", "r") as j_file:
            self.assertTrue(len(j_file.read()) == 53)
    ...
    def test_save_to_file_two_rectangles(self):
        ...
        with open("Rectangle.json", "r") as j_file:
            self.assertTrue(len(j_file.read()) == 105)

    def test_save_to_file_one_square(self):
        s = Square(10, 7, 2, 8)
        Square.save_to_file([s])
        with open("Square.json", "r") as j_file:
            self.assertTrue(len(j_file.read()) == 39)
    ...
    def test_save_to_file_two_squares(self):
        ...
        with open("Square.json", "r") as j_file:
            self.assertTrue(len(j_file.read()) == 77)

    def test_save_to_file_cls_name_for_filename(self):
        s = Square(10, 7, 2, 8)
        Base.save_to_file([s])
        with open("Base.json", "r") as j_file:
            self.assertTrue(len(j_file.read()) == 39)
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """testing load_from_file_csv methods"""
